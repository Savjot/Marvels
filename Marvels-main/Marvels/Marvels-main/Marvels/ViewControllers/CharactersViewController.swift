...
class CharactersViewController: UIViewController {
    ...
    func callToViewModelForUIUpdate() {
        ...
        self.charactersViewModel.marvelCharacterBindViewModelToController = {
    ...
    func updateDataSource()  {
        ...
        self.dataSource = CharactersDataSourceModel.init(cellIdentifier: Constants.kCharacterTableViewCellIdentifier, items:characters, configureCell: { (cell, character) in
        ...
        self.dataSource.handleCick = { (item) in
            self.performSegue(withIdentifier: Constants.kDetailScreen, sender: item)
        }
    }
