...
extension CharacterDetailViewModel {
    var characterImageURLString: String {
        guard let charDetail = characterDetail, let charThumbnail = charDetail.thumbnail, let path = charThumbnail.path, let imageExtension = charThumbnail.imageExtension else {return Constants.kEmptyString}
