...
class CharacterJSONMapping: XCTestCase {
    ...
    func testCharacterJSONMapping() throws {
        ...
        guard let filePath = testBundle.path(forResource: "CharactersResponse",ofType: "json") else{
            XCTFail("Missing file: CharactersResponse.json")
            return
        }
